...
(function (e) { function t(e, t) { var n = e, r = ""; while (n) {
...
}), ace.define("ace/mode/lua/luaparse", ["require", "exports", "module"], function (e, t, n) { (function (e, n, r) { r(t); })(this, "luaparse", function (e) {
    "use strict";
    function m(e) { if (mt) {
        var t = vt.pop();
        t.complete(), n.locations && (e.loc = t.loc), n.ranges && (e.range = t.range);
    } return e; }
    function w(e, t, n) { for (var r = 0, i = e.length; r < i; r++)
        if (e[r][t] === n)
            return r; return -1; }
    function E(e) { var t = g.call(arguments, 1); return e = e.replace(/%(\d)/g, function (e, n) { return "" + t[n - 1] || ""; }), e; }
    function S() { var e = g.call(arguments), t = {}, n, r; for (var i = 0, s = e.length; i < s; i++) {
        n = e[i];
        for (r in n)
            n.hasOwnProperty(r) && (t[r] = n[r]);
    } return t; }
    function x(e) { var t = E.apply(null, g.call(arguments, 1)), n, r; throw "undefined" != typeof e.line ? (r = e.range[0] - e.lineStart, n = new SyntaxError(E("[%1:%2] %3", e.line, r, t)), n.line = e.line, n.index = e.range[0], n.column = r) : (r = C - D + 1, n = new SyntaxError(E("[%1:%2] %3", _, r, t)), n.index = C, n.line = _, n.column = r), n; }
    function T(e, t) { x(t, d.expectedToken, e, t.value); }
    function N(e, t) { "undefined" == typeof t && (t = A.value); if ("undefined" != typeof e.type) {
        var n;
        switch (e.type) {
            case o:
                n = "string";
            ...
            case c:
                n = "boolean";
                break;
            case h: return x(e, d.unexpected, "symbol", "nil", t);
        }
        return x(e, d.unexpected, n, e.value, t);
    } return x(e, d.unexpected, "symbol", e, t); }
    function P() { H(); while (45 === t.charCodeAt(C) && 45 === t.charCodeAt(C + 1))
        X(), H(); if (C >= r)
        return { type: s, value: "<eof>", line: _, lineStart: D, range: [C, C] }; var e = t.charCodeAt(C), n = t.charCodeAt(C + 1); M = C; if (et(e))
        return B(); switch (e) {
        case 39:
        case 34: return I();
        case 48:
        ...
        case 35:
        case 45:
        case 43: return j(t.charAt(C));
    } return N(t.charAt(C)); }
    function H() { while (C < r) {
    ...
    function B() { var e, n; while (tt(t.charCodeAt(++C)))
    ...
    function I() { var e = t.charCodeAt(C++), n = C, i = "", s; while (C < r) {
        s = t.charCodeAt(C++);
        if (e === s)
            break;
        if (92 === s)
    ...
    function q() { var e = V(); return !1 === e && x(k, d.expected, "[", k.value), { type: o, value: e, line: _, lineStart: D, range: [M, C] }; }
    function R() { var e = t.charAt(C), n = t.charAt(C + 1), r = "0" === e && "xX".indexOf(n || null) >= 0 ? U() : z(); return { type: f, value: r, line: _, lineStart: D, range: [M, C] }; }
    function U() { var e = 0, n = 1, r = 1, i, s, o, u; u = C += 2, Z(t.charCodeAt(C)) || x({}, d.malformedNumber, t.slice(M, C)); while (Z(t.charCodeAt(C)))
        C++; i = parseInt(t.slice(u, C), 16); if ("." === t.charAt(C)) {
        s = ++C;
    ...
    function z() { while (Y(t.charCodeAt(C)))
        C++; if ("." === t.charAt(C)) {
        C++;
        while (Y(t.charCodeAt(C)))
            C++;
    ...
    function W() { var e = C; switch (t.charAt(C)) {
        case "n": return C++, "\n";
        case "r": return C++, "\r";
        case "t": return C++, "	";
        case "v": return C++, "";
    ...
    function X() { M = C, C += 2; var e = t.charAt(C), i = "", s = !1, o = C, u = D, a = _; "[" === e && (i = V(), !1 === i ? i = e : s = !0); if (!s) {
        while (C < r) {
            if (G(t.charCodeAt(C)))
                break;
            C++;
    ...
    function V() { var e = 0, n = "", i = !1, s, o; C++; while ("=" === t.charAt(C + e))
        e++; if ("[" !== t.charAt(C + e))
        return !1; C += e + 1, G(t.charCodeAt(C)) && (_++, D = C++), o = C; while (C < r) {
    ...
    function it(e) { switch (e.type) {
        case "CallExpression":
        case "TableCallExpression":
        case "StringCallExpression": return !0;
    } return !1; }
    function st(e) { if (s === e.type)
        return !0; if (u !== e.type)
    ...
    function Et() { $(), bt(); var e = St(); return s !== k.type && N(k), mt && !e.length && (L = k), m(v.chunk(e)); }
    function St(e) { var t = [], r; n.scope && ft(); while (!st(k)) {
        if ("return" === k.value) {
            t.push(xt());
            break;
        }
    ...
    function xt() { bt(); if (u === k.type)
        switch (k.value) {
            case "local": return $(), Dt();
            case "if": return $(), Mt();
            case "return": return $(), Ot();
            case "function":
                $();
                var e = jt();
                return Bt(e);
            case "while": return $(), Lt();
            case "for": return $(), _t();
            case "repeat": return $(), At();
            case "break": return $(), Nt();
            case "do": return $(), kt();
            case "goto": return $(), Ct();
        } if (l === k.type && J("::"))
        return Tt(); mt && vt.pop(); if (J(";"))
        return; return Pt(); }
    function Tt() { var e = k.value, t = Ht(); return n.scope && (ct("::" + e + "::"), pt(t, !0)), K("::"), m(v.labelStatement(t)); }
    function Nt() { return m(v.breakStatement()); }
    function Ct() { var e = k.value, t = Ht(); return n.scope && (t.isLabel = dt("::" + e + "::")), m(v.gotoStatement(t)); }
    function kt() { var e = St(); return K("end"), m(v.doStatement(e)); }
    function Lt() { var e = qt(); K("do"); var t = St(); return K("end"), m(v.whileStatement(e, t)); }
    function At() { var e = St(); K("until"); var t = qt(); return m(v.repeatStatement(t, e)); }
    function Ot() { var e = []; if ("end" !== k.value) {
        var t = It();
        null != t && e.push(t);
        while (J(","))
            t = qt(), e.push(t);
    ...
    function Mt() { var e = [], t, n, r; mt && (r = vt[vt.length - 1], vt.push(r)), t = qt(), K("then"), n = St(), e.push(m(v.ifClause(t, n))), mt && (r = gt()); while (J("elseif"))
        wt(r), t = qt(), K("then"), n = St(), e.push(m(v.elseifClause(t, n))), mt && (r = gt()); return J("else") && (mt && (r = new yt(L), vt.push(r)), n = St(), e.push(m(v.elseClause(n)))), K("end"), m(v.ifStatement(e)); }
    function _t() { var e = Ht(), t; n.scope && ht(e); if (J("=")) {
        var r = qt();
        K(",");
        var i = qt(), s = J(",") ? qt() : null;
        return K("do"), t = St(), K("end"), m(v.forNumericStatement(e, r, i, s, t));
    } var o = [e]; while (J(","))
        e = Ht(), n.scope && ht(e), o.push(e); K("in"); var u = []; do {
        var a = qt();
        u.push(a);
    } while (J(",")); return K("do"), t = St(), K("end"), m(v.forGenericStatement(o, u, t)); }
    function Dt() { var e; if (a === k.type) {
        var t = [], r = [];
        do
            e = Ht(), t.push(e);
        while (J(","));
        ...
        return e = Ht(), n.scope && ht(e), Bt(e, !0); T("<name>", k); }
    function Pt() { var e = k, t, n; mt && (n = gt()), t = zt(); if (null == t)
        return N(k); if (",=".indexOf(k.value) >= 0) {
        var r = [t], i = [], s;
        while (J(","))
    ...
    function Ht() { bt(); var e = k.value; return a !== k.type && T("<name>", k), $(), m(v.identifier(e)); }
    function Bt(e, t) { var r = []; K("("); if (!J(")"))
        for (;;)
            if (a === k.type) {
                var i = Ht();
                ...
                T("<name> or '...'", k);
            } var s = St(); return K("end"), t = t || !1, m(v.functionStatement(e, r, t, s)); }
    function jt() { var e, t, r; mt && (r = gt()), e = Ht(), n.scope && pt(e, !1); while (J("."))
        wt(r), t = Ht(), n.scope && pt(t, !1), e = m(v.memberExpression(e, ".", t)); return J(":") && (wt(r), t = Ht(), n.scope && pt(t, !1), e = m(v.memberExpression(e, ":", t))), e; }
    function Ft() { var e = [], t, n; for (;;) {
        bt();
        if (l === k.type && J("["))
    ...
    function It() { var e = Ut(0); return e; }
    function qt() { var e = It(); if (null != e)
        return e; T("<expression>", k); }
    function Rt(e) { var t = e.charCodeAt(0), n = e.length; if (1 === n)
        switch (t) {
            case 94: return 10;
            case 42:
            case 47:
        ...
        return 2; return 0; }
    function Ut(e) { var t = k.value, n, r; mt && (r = gt()); if (rt(k)) {
        bt(), $();
        var i = Ut(8);
        i == null && T("<expression>", k), n = m(v.unaryExpression(t, i));
    } null == n && (n = Xt(), null == n && (n = zt())); if (null == n)
        return null; var s; for (;;) {
    ...
    function zt() { var e, t, r, i; mt && (r = gt()); if (a === k.type)
    ...
    function Wt(e) { if (l === k.type)
        ...
        return m(v.stringCallExpression(e, Xt())); T("function arguments", k); }
    function Xt() { var e = o | f | c | h | p, n = k.value, r = k.type, i; mt && (i = gt()); if (r & e) {
        wt(i);
        var s = t.slice(k.range[0], k.range[1]);
        return $(), m(v.literal(r, n, s));
    } if (u === r && "function" === n)
        return wt(i), $(), Bt(null); if (J("{"))
        return wt(i), Ft(); }
    ...
    function Jt(e) { "undefined" != typeof e && $t(e), r = t.length, mt = n.locations || n.ranges, A = P(); var i = Et(); n.comments && (i.comments = O), n.scope && (i.globals = at); if (vt.length > 0)
