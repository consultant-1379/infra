ace.define("ace/mode/folding/coffee", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range"], function (e, t, n) {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./folding/coffee").FoldMode, o = e("./space_highlight_rules").SpaceHighlightRules, u = function () { this.HighlightRules = o, this.foldingRules = new s, this.$behaviour = this.$defaultBehaviour; };
    r.inherits(u, i), function () { this.$id = "ace/mode/space"; }.call(u.prototype), t.Mode = u;
});
