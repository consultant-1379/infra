ace.define("ace/ext/beautify/php_rules", ["require", "exports", "module", "ace/token_iterator"], function (e, t, n) {
    ...
    t.beautify = function (e) { var t = new r(e, 0, 0), n = t.getCurrentToken(), s = e.$modeId.split("/").pop(), o = i(t, s); e.doc.setValue(o); }, t.commands = [{ name: "beautify", exec: function (e) { t.beautify(e.session); }, bindKey: "Ctrl-Shift-B" }];
});
(function () {
