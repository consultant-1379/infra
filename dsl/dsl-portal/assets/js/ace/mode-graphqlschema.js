ace.define("ace/mode/graphqlschema_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./graphqlschema_highlight_rules").GraphQLSchemaHighlightRules, o = e("./folding/cstyle").FoldMode, u = function () { this.HighlightRules = s, this.foldingRules = new o; };
    r.inherits(u, i), function () { this.lineCommentStart = "#", this.$id = "ace/mode/graphqlschema"; }.call(u.prototype), t.Mode = u;
});
