        ...
        case "keybindings":
            switch (n) {
                ...
                case "emacs":
                    ...
                    break;
                default: e.setKeyboardHandler(null);
            }
            break;
        case "softWrap":
        case "fontSize":
            e.$setOption(t, n);
            break;
        default: e.$setOption(t, a(n));
    } }, e.getOption = function (t) { switch (t) {
        case "mode": return e.$getOption("mode").substr("ace/mode/".length);
        case "theme": return e.$getOption("theme").substr("ace/theme/".length);
        case "keybindings":
