...
(function (e) { function t(e, t) { var n = e, r = ""; while (n) {
    ...
    "use strict";
    var r, i, s = { '"': '"', "\\": "\\", "/": "/", b: "\b", f: "\f", n: "\n", r: "\r", t: "	" }, o, u = function (e) { throw { name: "SyntaxError", message: e, at: r, text: o }; }, a = function (e) { return e && e !== i && u("Expected '" + e + "' instead of '" + i + "'"), i = o.charAt(r), r += 1, i; }, f = function () { var e, t = ""; i === "-" && (t = "-", a("-")); while (i >= "0" && i <= "9")
        t += i, a(); if (i === ".") {
        t += ".";
        while (a() && i >= "0" && i <= "9")
            t += i;
        ...
        return e; u("Bad number"); }, l = function () { var e, t, n = "", r; if (i === '"')
        while (a()) {
            if (i === '"')
                return a(), n;
            if (i === "\\") {
                ...
                n += i;
        } u("Bad string"); }, c = function () { while (i && i <= " ")
        a(); }, h = function () { switch (i) {
        case "t": return a("t"), a("r"), a("u"), a("e"), !0;
        case "f": return a("f"), a("a"), a("l"), a("s"), a("e"), !1;
        case "n": return a("n"), a("u"), a("l"), a("l"), null;
    } u("Unexpected '" + i + "'"); }, p, d = function () { var e = []; if (i === "[") {
        a("["), c();
        if (i === "]")
            return a("]"), e;
        while (i) {
    ...
    } u("Bad array"); }, v = function () { var e, t = {}; if (i === "{") {
        a("{"), c();
        if (i === "}")
            return a("}"), t;
        while (i) {
    ...
    return p = function () { c(); switch (i) {
        case "{": return v();
        case "[": return d();
        case '"': return l();
        case "-": return f();
        default: return i >= "0" && i <= "9" ? f() : h();
    } }, function (e, t) { var n; return o = e, r = 0, i = " ", n = p(), c(), i && u("Syntax error"), typeof t == "function" ? function s(e, n) { var r, i, o = e[n]; if (o && typeof o == "object")
        for (r in o)
            Object.hasOwnProperty.call(o, r) && (i = s(o, r), i !== undefined ? o[r] = i : delete o[r]); return t.call(e, n, o); }({ "": n }, "") : n; };
