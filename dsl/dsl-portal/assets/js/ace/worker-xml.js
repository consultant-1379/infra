...
(function (e) { function t(e, t) { var n = e, r = ""; while (n) {
...
}), ace.define("ace/mode/xml/sax", ["require", "exports", "module"], function (e, t, n) { function d() { } function v(e, t, n, r, i) { function s(e) { if (e > 65535) {
    e -= 65536;
    var t = 55296 + (e >> 10), n = 56320 + (e & 1023);
    return String.fromCharCode(t, n);
} return String.fromCharCode(e); } function o(e) { var t = e.slice(1, -1); return t in n ? n[t] : t.charAt(0) === "#" ? s(parseInt(t.substr(1).replace("x", "0x"))) : (i.error("entity not found:" + e), e); } function u(t) { var n = e.substring(v, t).replace(/&#?\w+;/g, o); h && a(v), r.characters(n, 0, t - v), v = t; } function a(t, n) { while (t >= l && (n = c.exec(e)))
    f = n.index, l = f + n[0].length, h.lineNumber++; h.columnNumber = t - f + 1; } var f = 0, l = 0, c = /.+(?:\r\n?|\n)|.*$/g, h = r.locator, p = [{ currentNSMap: t }], d = {}, v = 0; for (;;) {
    var E = e.indexOf("<", v);
    if (E < 0) {
    ...
    k < 0 ? u(E + 1) : v = k;
} } function m(e, t) { return t.lineNumber = e.lineNumber, t.columnNumber = e.columnNumber, t; } function g(e, t, n, r, i) { var s, d, v = ++t, m = o; for (;;) {
    var g = e.charAt(v);
    switch (g) {
        case "=":
            if (m === u)
        ...
        case "/":
            switch (m) {
                case o: n.setTagName(e.slice(t, v));
                case c:
                case h:
                case p: m = p, n.closed = !0;
                case l:
                case u:
                case a: break;
        ...
        case ">":
            switch (m) {
                ...
                case p: break;
                case l:
                case u: d = e.slice(t, v), d.slice(-1) === "/" && (n.closed = !0, d = d.slice(0, -1));
                case a:
                    ...
                    break;
                case f: throw new Error("attribute value missed!!");
            }
            return v;
        case "\u0080": g = " ";
        default: if (g <= " ")
            ...
            switch (m) {
                case a:
                    ...
                    break;
                case c: i.warning('attribute space is required"' + s + '"!!');
                case h:
                    m = u, t = v;
                    break;
                case f:
                    m = l, t = v;
                    break;
                case p: throw new Error("elements closed character '/' and '>' must be connected to");
            }
    }
    v++;
} } function y(e, t, n) { var r = e.tagName, i = null, s = n[n.length - 1].currentNSMap, o = e.length; while (o--) {
...
} var o = e.length; while (o--) {
    u = e[o];
    var c = u.prefix;
    c && (c === "xml" && (u.uri = "http://www.w3.org/XML/1998/namespace"), c !== "xmlns" && (u.uri = s[c]));
} var l = r.indexOf(":"); l > 0 ? (c = e.prefix = r.slice(0, l), h = e.localName = r.slice(l + 1)) : (c = null, h = e.localName = r); var d = e.uri = s[c || ""]; t.startElement(d, h, r, e); if (e.closed) {
    t.endElement(d, h, r);
    if (i)
        for (c in i)
    ...
    e.currentNSMap = s, e.localNSMap = i, n.push(e); } function b(e, t, n, r, i) { if (/^(?:script|textarea)$/i.test(n)) {
...
} return t + 1; } function w(e, t, n, r) { var i = r[n]; return i == null && (i = r[n] = e.lastIndexOf("</" + n + ">")), i < t; } function E(e, t) { for (var n in e)
    t[n] = e[n]; } function S(e, t, n, r) { var i = e.charAt(t + 2); switch (i) {
    case "-":
        if (e.charAt(t + 3) === "-") {
            var s = e.indexOf("-->", t + 4);
...
} return -1; } function x(e, t, n) { var r = e.indexOf("?>", t); if (r) {
    ...
    return -1;
} return -1; } function T(e) { } function N(e, t) { return e.__proto__ = t, e; } function C(e, t) { var n, r = [], i = /'[^']+'|"[^"]+"|[^\s<>\/=]+=?|(\/?\s*>|<)/g; i.lastIndex = t, i.exec(e); while (n = i.exec(e)) {
    r.push(n);
    if (n[1])
        return r;
} } var r = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, i = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) + "\u00b7\u0300-\u036f\\ux203F-\u2040]"), s = new RegExp("^" + r.source + i.source + "*(?::" + r.source + i.source + "*)?$"), o = 0, u = 1, a = 2, f = 3, l = 4, c = 5, h = 6, p = 7; return d.prototype = { parse: function (e, t, n) { var r = this.domBuilder; r.startDocument(), E(t, t = {}), v(e, t, n, r, this.errorHandler), r.endDocument(); } }, T.prototype = { setTagName: function (e) { if (!s.test(e))
        throw new Error("invalid tagName:" + e); this.tagName = e; }, add: function (e, t, n) { if (!s.test(e))
        throw new Error("invalid attribute:" + e); this[this.length++] = { qName: e, value: t, offset: n }; }, length: 0, getLocalName: function (e) { return this[e].localName; }, getOffset: function (e) { return this[e].offset; }, getQName: function (e) { return this[e].qName; }, getURI: function (e) { return this[e].uri; }, getValue: function (e) { return this[e].value; } }, N({}, N.prototype) instanceof N || (N = function (e, t) { function n() { } n.prototype = t, n = new n; for (t in e)
    n[t] = e[t]; return n; }), d; }), ace.define("ace/mode/xml/dom", ["require", "exports", "module"], function (e, t, n) { function r(e, t) { for (var n in e)
    t[n] = e[n]; } function i(e, t) { var n = e.prototype; if (Object.create) {
    var i = Object.create(t.prototype);
    n.__proto__ = i;
} if (!(n instanceof t)) {
    function s() { }
    s.prototype = t.prototype, s = new s, r(n, s), e.prototype = n = s;
} n.constructor != e && (typeof e != "function" && console.error("unknow Class:" + e), n.constructor = e); } function B(e, t) { if (t instanceof Error)
    var n = t;
else
    n = this, Error.call(this, w[e]), this.message = w[e], Error.captureStackTrace && Error.captureStackTrace(this, B); return n.code = e, t && (this.message = this.message + ": " + t), n; } function j() { } function F(e, t) { this._node = e, this._refresh = t, I(this); } function I(e) { var t = e._node._inc || e._node.ownerDocument._inc; if (e._inc != t) {
    var n = e._refresh(e._node);
    gt(e, "length", n.length), r(n, e), e._inc = t;
} } function q() { } function R(e, t) { var n = e.length; while (n--)
    if (e[n] === t)
        return n; } function U(e, t, n, r) { r ? t[R(t, r)] = n : t[t.length++] = n; if (e) {
    n.ownerElement = e;
    var i = e.ownerDocument;
    i && (r && Q(i, e, r), K(i, e, n));
} } function z(e, t, n) { var r = R(t, n); if (!(r >= 0))
    throw B(L, new Error); var i = t.length - 1; while (r < i)
    t[r] = t[++r]; t.length = i; if (e) {
    var s = e.ownerDocument;
    s && (Q(s, e, n), n.ownerElement = null);
} } function W(e) { this._features = {}; if (e)
    for (var t in e)
        this._features = e[t]; } function X() { } function V(e) { return e == "<" && "&lt;" || e == ">" && "&gt;" || e == "&" && "&amp;" || e == '"' && "&quot;" || "&#" + e.charCodeAt() + ";"; } function $(e, t) { if (t(e))
    return !0; if (e = e.firstChild)
    do
        if ($(e, t))
            return !0;
    while (e = e.nextSibling); } function J() { } function K(e, t, n) { e && e._inc++; var r = n.namespaceURI; r == "http://www.w3.org/2000/xmlns/" && (t._nsMap[n.prefix ? n.localName : ""] = n.value); } function Q(e, t, n, r) { e && e._inc++; var i = n.namespaceURI; i == "http://www.w3.org/2000/xmlns/" && delete t._nsMap[n.prefix ? n.localName : ""]; } function G(e, t, n) { if (e && e._inc) {
    e._inc++;
    var r = t.childNodes;
    if (n)
        r[r.length++] = n;
...
} } function Y(e, t) { var n = t.previousSibling, r = t.nextSibling; return n ? n.nextSibling = r : e.firstChild = r, r ? r.previousSibling = n : e.lastChild = n, G(e.ownerDocument, e), t; } function Z(e, t, n) { var r = t.parentNode; r && r.removeChild(t); if (t.nodeType === g) {
    var i = t.firstChild;
    if (i == null)
        return t;
    var s = t.lastChild;
    ...
    i = s = t; var o = n ? n.previousSibling : e.lastChild; i.previousSibling = o, s.nextSibling = n, o ? o.nextSibling = i : e.firstChild = i, n == null ? e.lastChild = s : n.previousSibling = s; do
    i.parentNode = e;
while (i !== s && (i = i.nextSibling)); return G(e.ownerDocument || e, e), t.nodeType == g && (t.firstChild = t.lastChild = null), t; } function et(e, t) { var n = t.parentNode; if (n) {
    var r = e.lastChild;
    n.removeChild(t);
    var r = e.lastChild;
} var r = e.lastChild; return t.parentNode = e, t.previousSibling = r, t.nextSibling = null, r ? r.nextSibling = t : e.firstChild = t, e.lastChild = t, G(e.ownerDocument, e, t), t; } function tt() { this._nsMap = {}; } function nt() { } function rt() { } function it() { } function st() { } function ot() { } function ut() { } function at() { } function ft() { } function lt() { } function ct() { } function ht() { } function pt() { } function dt(e, t) { switch (e.nodeType) {
    case u:
    ...
    case g:
        ...
        while (i)
            dt(i, t), i = i.nextSibling;
        return;
    case a: return t.push(" ", e.name, '="', e.value.replace(/[<&"]/g, V), '"');
    case f: return t.push(e.data.replace(/[<&]/g, V));
    case l: return t.push("<![CDATA[", e.data, "]]>");
    case d: return t.push("<!--", e.data, "-->");
    case m:
    ...
    case c: return t.push("&", e.nodeName, ";");
    default: t.push("??", e.nodeName);
} } function vt(e, t, n) { var r; switch (t.nodeType) {
    case u: r = t.cloneNode(!1), r.ownerDocument = e;
    case g: break;
    case a: n = !0;
} r || (r = t.cloneNode(!1)), r.ownerDocument = e, r.parentNode = null; if (n) {
    var i = t.firstChild;
    while (i)
        r.appendChild(vt(e, i, n)), i = i.nextSibling;
} return r; } function mt(e, t, n) { var r = new t.constructor; for (var i in t) {
    var s = t[i];
    typeof s != "object" && s != r[i] && (r[i] = s);
} t.childNodes && (r.childNodes = new j), r.ownerDocument = e; switch (r.nodeType) {
    case u:
    ...
    } return null; }, lookupNamespaceURI: function (e) { var t = this; while (t) {
        var n = t._nsMap;
        if (n && e in n)
            return n[e];
        t = t.nodeType == 2 ? t.ownerDocument : t.parentNode;
    } return null; }, isDefaultNamespace: function (e) { var t = this.lookupPrefix(e); return t == null; } }, r(o, X), r(o, X.prototype), J.prototype = { nodeName: "#document", nodeType: v, doctype: null, documentElement: null, _inc: 1, insertBefore: function (e, t) { if (e.nodeType == g) {
        var n = e.firstChild;
        while (n) {
            var r = n.nextSibling;
    ...
    if (Object.defineProperty) {
        Object.defineProperty(F.prototype, "length", { get: function () { return I(this), this.$$length; } }), Object.defineProperty(X.prototype, "textContent", { get: function () { return yt(this); }, set: function (e) { switch (this.nodeType) {
                ...
                case 11:
                    ...
                    break;
                default: this.data = e, this.value = value, this.nodeValue = e;
            } } });
        function yt(e) { switch (e.nodeType) {
            case 1:
            case 11:
                var t = [];
                e = e.firstChild;
...
catch (bt) { } return W; }), ace.define("ace/mode/xml/dom-parser", ["require", "exports", "module", "ace/mode/xml/sax", "ace/mode/xml/dom"], function (e, t, n) {
    "use strict";
    function s(e) { this.options = e || { locator: {} }; }
    function o(e, t, n) { function s(t) { var s = e[t]; if (!s)
        if (i)
            s = e.length == 2 ? function (n) { e(t, n); } : e;
        else {
            var o = arguments.length;
            while (--o)
                if (s = e[arguments[o]])
                    break;
        } r[t] = s && function (e) { s(e + f(n), e, n); } || function () { }; } if (!e) {
        if (t instanceof u)
            return t;
        e = t;
    } var r = {}, i = e instanceof Function; return n = n || {}, s("warning", "warn"), s("error", "warn", "warning"), s("fatalError", "warn", "warning", "error"), r; }
    ...
    var r = e("./sax"), i = e("./dom");
    return s.prototype.parseFromString = function (e, t) { var n = this.options, i = new r, s = n.domBuilder || new u, a = n.errorHandler, f = n.locator, l = n.xmlns || {}, c = { lt: "<", gt: ">", amp: "&", quot: '"', apos: "'" }; return f && s.setDocumentLocator(f), i.errorHandler = o(a, s, f), i.domBuilder = n.domBuilder || s, /\/x?html?$/.test(t) && (c.nbsp = "\u00a0", c.copy = "\u00a9", l[""] = "http://www.w3.org/1999/xhtml"), e ? i.parse(e, l, c) : i.errorHandler.error("invalid document source"), s.document; }, u.prototype = { startDocument: function () { this.document = (new i).createDocument(null, null, null), this.locator && (this.document.documentURI = this.locator.systemId); }, startElement: function (e, t, n, r) { var i = this.document, s = i.createElementNS(e, n || t), o = r.length; c(this, s), this.currentElement = s, this.locator && a(this.locator, s); for (var u = 0; u < o; u++) {
        ...
        } }, endElement: function (e, t, n) { var r = this.currentElement, i = r.tagName; this.currentElement = r.parentNode; }, startPrefixMapping: function (e, t) { }, endPrefixMapping: function (e) { }, processingInstruction: function (e, t) { var n = this.document.createProcessingInstruction(e, t); this.locator && a(this.locator, n), c(this, n); }, ignorableWhitespace: function (e, t, n) { }, characters: function (e, t, n) { e = l.apply(this, arguments); if (this.currentElement && e) {
            if (this.cdata) {
        ...
        } }, skippedEntity: function (e) { }, endDocument: function () { this.document.normalize(); }, setDocumentLocator: function (e) { if (this.locator = e)
            e.lineNumber = 0; }, comment: function (e, t, n) { e = l.apply(this, arguments); var r = this.document.createComment(e); this.locator && a(this.locator, r), c(this, r); }, startCDATA: function () { this.cdata = !0; }, endCDATA: function () { this.cdata = !1; }, startDTD: function (e, t, n) { var r = this.document.implementation; if (r && r.createDocumentType) {
            var i = r.createDocumentType(e, t, n);
            this.locator && a(this.locator, i), c(this, i);
        } }, warning: function (e) { console.warn(e, f(this.locator)); }, error: function (e) { console.error(e, f(this.locator)); }, fatalError: function (e) { throw console.error(e, f(this.locator)), e; } }, "endDTD,startEntity,endEntity,attributeDecl,elementDecl,externalEntityDecl,internalEntityDecl,resolveEntity,getExternalSubset,notationDecl,unparsedEntityDecl".replace(/\w+/g, function (e) { u.prototype[e] = function () { return null; }; }), { DOMParser: s };
